        ...
        <header className='md:flex justify-center gap-[21px] items-center ml-[27px] '>
            ...
            <div className='max-w-[687px] w-full'>
                <div className='text-darkGreen'>
                    <h1 className='md:text-[52px] text-3xl md:text-left text-center font-extrabold md:leading-[55px] mb-2'>Chance to win a StockX <p className='m-0'>Mystery Box today!</p></h1>
                ...
                <form className='border border-grey rounded-[20px] px-[24px] py-6 mt-[23px] grid gap-4'>
                    ...
                    <button className='w-full bg-green rounded-[10px] py-3 font-semibold text-[#ffffff] '>PROCED TO PAYMENT</button>
