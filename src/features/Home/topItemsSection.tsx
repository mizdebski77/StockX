...
export const TopItemsSection = () => {
    return (
        <section className='mt-12'>
            <h2 className='md:text-5xl text-3xl text-center font-bold text-darkGreen md:leading-[55px] '>Top Tech Mystery Box<p>
                at Unbeatable Prices
            </p>
            </h2>
            <p className='md:text-xl text-lg text-[#006340] text-center font-medium mt-2'>Fast shipping | Easy returns | Special discounts for students</p>

            <div className='grid md:grid-cols-2 items-center px-4 mt-8' >
                <img src={img} alt='mystery box' className=' max-w-[583px] w-full ' />
                <div className='text-center md:text-left'>
                    <h3 className='md:text-[42px] text-3xl font-bold mb-8 md:text-left text-center'>Curious about the <span className='text-[#006340]'>StockX</span><p className='m-0'> Mystery Box?</p></h3>
