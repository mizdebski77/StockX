...
export const TopItemsSection = () => {
    return (
        <section className="mt-12 max-w-[1500px] m-auto">
            ...
            <div className="grid md:grid-cols-2 items-center px-4 mt-8 gap-8">
                <img
                    src={img}
                    alt="mystery box"
                    className="max-w-[583px] w-full"
                />
                <div className="text-center md:text-left">
                    <h3 className="md:text-[42px] text-darkGreen text-3xl font-bold mb-8 md:text-left text-center">
                        Curious about the{" "}
                        <span className="text-[#006340]">StockX</span>
                        <p className="m-0"> Mystery Box?</p>
                    </h3>
                    <p className="text-darkGreen mb-2">
                        Experience the thrill of unboxing cutting-edge gadgets
                        with StockX Mystery Boxes. Each box is a treasure trove
                        of high-quality electronics, handpicked to elevate your
                        tech game.
                    </p>
            ...
            <div className="grid md:grid-cols-2 items-center px-4 mt-9 gap-8">
                <div className="text-center md:text-left">
                    ...
                    <p className="text-darkGreen mb-2">
                        ...
                        they’re about the experience. Imagine the excitement of
                        unveiling top-tier electronics at a fraction of the
                        cost.
                    </p>
                    <p className="text-darkGreen">
                        Our boxes include a variety of premium tech items,
                        making it a must-have for every tech enthusiast. Join
                        the buzz and see why everyone is raving about the
                        unbeatable value and surprise factor of StockX Mystery
                        Boxes!
                    </p>
                </div>
                <img
                    src={img2}
                    alt="mystery box second"
                    className="max-w-[583px] w-full"
                />
            </div>
        </section>
